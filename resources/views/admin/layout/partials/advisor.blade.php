<div class="advisor-container" id="advisor-container">
   
    <div class="advisor success">
       
        <p class="advisor-type"></p>
        <p class="advisor-description" id="advisor-description-success"></p>
    ...
    <div class="advisor error" >
        ...
        <p class="advisor-type"></p>
        <p class="advisor-description" id="advisor-description-error"></p>
