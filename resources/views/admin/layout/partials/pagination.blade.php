<div class="pagination-table">
    <div class="pagination-table-buttons">
        <p>
           <div>
                <span class="pagination-table-button" data-page="{{$items->url(1)}}">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M18.41,16.59L13.82,12L18.41,7.41L17,6L11,12L17,18L18.41,16.59M6,6H8V18H6V6Z" />
                    </svg>
                </span>
            
                <span class="pagination-table-button" data-page="{{$items->previousPageUrl()}}">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <div>
                <span class="pagination-table-button" data-page="{{$items->nextPageUrl()}}">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" />
                    </svg>
                </span>

                <span class="pagination-table-button" data-page="{{$items->url($items->lastPage())}}">
                    <svg style="width:24px;height:24px" viewBox="0 0 24 24">
